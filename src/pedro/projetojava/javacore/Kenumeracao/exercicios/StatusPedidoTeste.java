...
import pedro.projetojava.javacore.Kenumeracao.dominioExercicios.PagamentoPedido;
...
public class StatusPedidoTeste {
    public static void main(String[] args) {
        ...
        Pedido pedido = new Pedido("2134124241", "Livro Nacional");
        PagamentoPedido pagamentoPedido = new PagamentoPedido("2134124241", "Livro Nacional", 250);
        ...
        while(true) {
            ...
            if (valorAPagar == pagamentoPedido.valorTotal) {
            ...
            } else if (valorAPagar > pagamentoPedido.valorTotal || valorAPagar < pagamentoPedido.valorTotal) {
